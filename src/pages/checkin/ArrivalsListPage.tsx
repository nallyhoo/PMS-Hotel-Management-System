  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-serif font-light mb-1">Today's Arrivals</h1>
          <p className="text-sm text-[#1a1a1a]/60 font-light">Comprehensive list of guests arriving today.</p>
        </div>
                ...
                <tr key={res.reservationId} className="hover:bg-[#f8f9fa] transition-colors group">
                  ...
                  <td className="px-6 py-4">
                    <span className={`text-[10px] uppercase tracking-widest font-bold px-2 py-0.5 rounded ${
                      res.status === 'Checked In' ? 'bg-emerald-50 text-emerald-600' : 'bg-blue-50 text-blue-600'
                    }`}>
                      {res.status}
                    </span>
                  </td>

    ...
    <div className="max-w-4xl mx-auto space-y-8 pb-20">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-serif font-medium text-[#1a1a1a]">Add New Inventory Item</h1>
            <p className="text-[#1a1a1a]/40 text-sm mt-1">Register a new asset or stock item in the system</p>
          </div>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="bg-white p-8 rounded-3xl border border-[#1a1a1a]/5 shadow-sm space-y-8">
              ...
              <div className="space-y-2">
                ...
                <textarea 
                  rows={4}
                  placeholder="Enter item details, storage requirements, etc."
            ...
            <div className="bg-white p-8 rounded-3xl border border-[#1a1a1a]/5 shadow-sm space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="space-y-2">
                  <label className="text-[10px] uppercase tracking-widest font-semibold text-[#1a1a1a]/40">Initial Stock</label>
                  <input 
                    type="number" 
                    className="w-full px-4 py-3 bg-[#f8f9fa] border-none rounded-xl focus:ring-2 focus:ring-[#1a1a1a]/5 outline-none text-sm font-medium"
          ...
          <div className="space-y-8">
            <div className="bg-[#1a1a1a] rounded-3xl p-8 text-white space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <input 
                    type="text" 
                    placeholder="e.g. Main Cellar, Shelf B"
                    className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl focus:ring-2 focus:ring-white/10 outline-none text-sm font-medium text-white"
            ...
            <div className="bg-amber-50 p-6 rounded-3xl border border-amber-100 flex gap-4 text-amber-800">
              <AlertCircle size={20} className="shrink-0 mt-0.5" />
              <p className="text-xs leading-relaxed opacity-80">
                Setting an accurate <b>Min Stock Alert</b> level ensures you never run out of critical supplies.
              </p>
            </div>

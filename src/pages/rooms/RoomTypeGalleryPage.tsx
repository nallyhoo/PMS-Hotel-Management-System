  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-[#1a1a1a]/60 font-light">{roomType.name} • {roomType.images.length} Images</p>
          </div>
        </div>
        <div className="flex items-center gap-3">
          {selectedImages.length > 0 && (
            <button className="flex items-center gap-2 px-4 py-2 bg-red-50 text-red-600 rounded-xl text-xs font-medium uppercase tracking-widest hover:bg-red-100 transition-colors">
              <Trash2 size={14} />
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {/* Upload Placeholder */}
        <div className="aspect-square bg-[#f8f9fa] rounded-2xl border-2 border-dashed border-[#1a1a1a]/10 flex flex-col items-center justify-center p-8 hover:border-[#1a1a1a]/30 transition-all cursor-pointer group">
